    ...
    "outputs": [
      {
        ...
        "internalType": "struct ICreditNFT.CreditMetadata",
        "name": "",
        "type": "tuple"
      }
    ],
...
export type CreditNFTABI = typeof CreditNFTABI;
