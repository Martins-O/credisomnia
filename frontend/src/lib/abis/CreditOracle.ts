...
export const CreditOracleABI = [
    ...
    "outputs": [
      {
        ...
        "internalType": "struct ICreditOracle.CreditProfile",
        "name": "",
        "type": "tuple"
      }
    ],
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "uint256",
        "name": "newBaseCollateralRatio",
        "type": "uint256"
      }
    ],
    "name": "updateScoringParameters",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
...
export type CreditOracleABI = typeof CreditOracleABI;
